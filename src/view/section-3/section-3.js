            ...
            <section className="section-3">
                <div className="div-section-3">
                    ...
                    <div className="img-link-section-3">
                        <a href="http://numbersbelieve.com/" target="_blank"><img src={NumbersBelieve} alt="numbers-believe" /></a>
                        <a href="https://mondora.com/" target="_blank"><img src={Mondora} alt="mondora" /></a>
                        <a href="http://numbersbelieve.com/omnia" target="_blank"><img src={Omnia} alt="omnia" /></a>
                    </div>
                </div>
            </section>
        </>
